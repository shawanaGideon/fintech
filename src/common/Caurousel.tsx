...
import ArrowFront from "../assets/icons/arrow_forward.svg";
...
function Caurousel({ slides }: CarouselProps) {
  ...
  return (
    <div className="relative h-[400px] max-w-[400px] overflow-hidden rounded-2xl ">
      ...
      <img
        className="absolute bottom-5 right-16 h-7 rounded-full border p-1 hover:cursor-pointer"
        onClick={previousSlide}
        src={ArrowBack}
        alt="Previous slide button"
      />
      <img
        className="absolute bottom-5 right-7 h-7 rounded-full border p-1 hover:cursor-pointer"
        onClick={nextSlide}
        src={ArrowFront}
