import Caurousel from "../common/Caurousel";
...
function Reviews() {
  ...
  return (
    ...
    <h2 className="mb-4 max-w-[16ch] text-center text-4xl font-semibold text-gray-800 lg:max-w-full lg:text-left">
      Join other thousands of people growing with Kobodrop
    </h2>
    <p className="mb-4 max-w-[40ch] text-center text-lg font-medium text-gray-600 lg:max-w-full lg:text">Be part of the winning team with kobodrop</p>
    <StoreLink type={BtnTypes.Standard} />
  </article>
      <Caurousel slides={slides} /> 
    </section>
  );
}
