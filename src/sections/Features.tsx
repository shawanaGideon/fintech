  ...
  return (
    ...
    >
      ...
      <article className="flex w-full flex-col gap-8 overflow-hidden xl:h-96 xl:flex-row">
        <div className="flex flex-col rounded-2xl bg-sky-100 p-4 sm:p-0 md:flex-row xl:w-2/3">
          <div className="mt-10 flex flex-col justify-center gap-4 text-center sm:mx-10 md:ml-10 md:w-1/2 md:text-left">
            <h2 className="text-3xl font-semibold text-gray-800 sm:w-[18ch]">
              Pay with Kobodrop, quick, simple and easy
            </h2>
            <p className="text-gray-500 sm:w-[34ch]">
          ...
          <div className="md:w-1/ 2 m-auto mt-10 max-w-72 md:mx-10 lg:mx-0">
        ...
        <div className="flex flex-col justify-center gap-4 rounded-2xl bg-indigo-100 p-10 xl:w-1/3">
          <div className="w-fit rounded-full bg-indigo-200 p-4">
            <img src={ShieldCheck} alt="Kobodrop app frame" />
          </div>
          <div>
      ...
      <article className="flex w-full flex-col gap-8  xl:h-96 xl:flex-row">
        ...
        <div className="flex flex-col gap-8 overflow-hidden rounded-2xl bg-yellow-100 p-4 sm:p-0 md:flex-row xl:w-2/3">
          <div className="mt-10 flex flex-col justify-center gap-4 text-center sm:mx-10 md:ml-10 md:mt-0 md:w-1/2 md:text-left">
            <h2 className="text-3xl font-semibold text-gray-800 sm:w-[18ch]">
          ...
          <div className="md:w-1/2 m-auto max-w-96 md:mt-36">
            <img src={Frames} alt="Frames displaying various payment solutions" />
          </div>
        </div>
      </article>
    </section>
